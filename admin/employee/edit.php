<?php  
 ...
 @$empid = $_GET['id'];
  ...
  $radio = '';
  if ($emp && property_exists($emp, 'SEX')) {
      if ($emp->SEX == 'Male') {
  ...
  if ($emp !== null && property_exists($emp, 'CIVILSTATUS')) {
      ...
      echo "Employee object is null or does not have 'CIVILSTATUS' property.";
  }  
 ...
 ?> 
       ...
       <div class="center wow fadeInDown">
             <h2 class="page-header">Update Employee</h2>
                ...
                <input  id="APPLICANTID" name="APPLICANTID" type="hidden" value="<?php echo $emp->APPLICANTID;?>"  >
                             ...
                             <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="CIVILSTATUS" name="CIVILSTATUS" placeholder=
                                      "Conact No." type="text" any value="<?php echo $emp->CIVILSTATUS;?>" required   autocomplete="off">
                                </div>
                              </div>
                            </div> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="USERNAME" name="USERNAME" placeholder=
                                      "Postion" type="text" any value="<?php echo $emp->USERNAME;?>" required   autocomplete="off">
                                </div>
                              </div>
                            </div>
